...
fig = go.Figure(data=[go.Candlestick(
    ...
    open=new_df_Mth['開盤'],    # Assuming "開盤" is the opening price column
    high=new_df_Mth['最高'],    # Assuming "最高" is the highest price column
    low=new_df_Mth['最低'],     # Assuming "最低" is the lowest price column
    close=new_df_Mth['收盤'],    # Assuming "收盤" is the closing price column
...
# Assuming you have the 'new_df_Mth' DataFrame with the calculated values

fig = go.Figure(data=[go.Candlestick(
    x=new_df_Mth['開倉日期'],  # Assuming "開倉日期" is the date column
    open=new_df_Mth['開盤'],    # Assuming "開盤" is the opening price column
    high=new_df_Mth['最高'],    # Assuming "最高" is the highest price column
    low=new_df_Mth['最低'],     # Assuming "最低" is the lowest price column
    close=new_df_Mth['收盤'],    # Assuming "收盤" is the closing price column
