# -*- coding: utf-8 -*-
"""TX_futures_月合約全日k gspread _v02_1140215 編訂中

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1w-C4sQzqqSMj9W76hEOn6tyMctAUyAfk
"""
...
"""# 114.2.2 編寫月合約全日盤
  114.2.8 維修: 周合約全日盤遇假日延後遞延結算 或 逢長假如農曆假期而提前封關 狀況 -> v02 1140208周全日 撰寫成 月全日盤合約
...
"""# 2. Define the head & tail of each week contract
From top-to-buttom of df reaching the Wed., if yes tagged "contract close" and tagged next row "contract open", else check  diff. from last contract open >9, >6 if yes tagged contract close in i-1 and i (Key: to fix the contract duration as meet the long days off of stock office)
...
"""５．Build a Monthly contract table named new_df_Mth"""
...
# Calculate values for the new columns after extracting data from df
new_df_Mth['cost'] = new_df_Mth['cost'].astype(float)  # Change data type to float
for index, row in new_df_Mth.iterrows():
...
new_df2=new_df_Mth #The copy of data frame is also changed to new_df_Mth
new_df2
...
2. the dataset is transferred to the  worksheet,Monthly, of spreadsheet,關卡價
"""
